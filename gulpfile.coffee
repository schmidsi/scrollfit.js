...
paths =
    jade:   ['./test/example/templates/**/*.jade'] # <%= frontendDir %>
    stylus:
        watch:      ['./test/example/styles/**/*.styl']
        compile:    ['./test/example/styles/main.styl']
    coffee:
        path:       './src/**/*.coffee'
